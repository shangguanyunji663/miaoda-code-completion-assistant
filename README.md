...
├── desktop/                        # Electron 桌面壳（本分支 0.1.0）：构建见 desktop/README.md，用户说明见《桌面版说明.md》
